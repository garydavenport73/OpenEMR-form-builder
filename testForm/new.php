...
<!-- ----------GENERATE---------------- -->
    ...
    <?php
		$myText = 'Some prefilled text here is possible.';
		$myTime = '13:00';
		$myInteger = '50';
		$myFloat = '51.5';
		$myCheckbox = 'on';
		$myTextarea = 'You can put prefilled text here.';
		$myRadio = '';
...
<!-- ----------GENERATE---------------- -->
			...
			<div>
<label for='myCheckbox'>This is my checkbox (not set to required but pre-checked).</label>			<?php echo"
				<input id='myCheckbox' name='myCheckbox' type='checkbox' value='on' checked >
			"; ?>
			</div>
			<div>
